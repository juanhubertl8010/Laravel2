  ...
  <!-- Jumbotron -->
    ...
    <div class="container my-5">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
            @php
                $nameStrip = str($product->name)->replace(' ', '-');
            @endphp
            <a href="{{ url("/product/{$product->id}-{$nameStrip}") }}">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="#!" class="btn btn-primary shadow-0 me-1 btnAddCart" data-id="{{ $product->id }}">Add to cart</a>
